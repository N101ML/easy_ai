...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { model_id: @training.model_id, name: @training.name } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { model_id: @training.model_id, name: @training.name } }
